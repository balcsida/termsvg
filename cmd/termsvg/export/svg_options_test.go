	...
	tests := []struct {
		...
		},
		{
			...
			want: svg.Options{
				...
				MaxFPS:        30,
				AutoObjective: svg.AutoObjectiveSize, Style: svg.StyleLegacy,
			},
		},
		{name: "runtime objective", cmd: Cmd{SVGLayout: "AUTO", SVGAutoObjective: "RUNTIME"}, format: "svg", want: svg.Options{Layout: svg.LayoutAuto, Animation: svg.AnimationCSS, FrameSwitch: svg.FrameSwitchTranslate, AutoObjective: svg.AutoObjectiveRuntime, Style: svg.StyleLegacy}},
		{name: "auto style", cmd: Cmd{SVGStyle: "AUTO"}, format: "svg", want: svg.Options{Layout: svg.LayoutFrames, Animation: svg.AnimationCSS, FrameSwitch: svg.FrameSwitchTranslate, AutoObjective: svg.AutoObjectiveSize, Style: svg.StyleAuto}},
